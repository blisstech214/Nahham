  ...
  return (
    <div className="layout-wrapper">
      ...
      >
        ...
        {/* Banner Sec */}
        <div className="header-banner mb-5" id="home">
          <div
        ...
        <div className="container border-layer1 bg-white main-bg rounded-5">
          <div className="border-layer2 rounded-bottom-5">
            <div className="row">
              <div className="col-md-6">
                <div
                  className="vision-box p-5 text-white rounded-5 m-5"
                  style={{ backgroundColor: "#6D5F27" }}
                >
                  <Slider ref={sliderRef} {...settings}>
                    {slides.map((slide, index) => (
                      <div key={index}>
                        <h6 className="fw-lighter">{slide.title}</h6>
                        <h4 className="fw-bold">{slide.heading}</h4>
                        <p className="fw-lighter">{slide.description}</p>
                      </div>
                    ))}
                  </Slider>
                  <div className="d-flex justify-content-end arrows">
                    ...
                    <img
                      src={arrowRight}
                      alt="Arrow Right"
                      className="rounded-5 arrow2 ms-2"
                      style={{ cursor: "pointer" }}
              ...
              <div className="col-md-6">
                <div className="about-us-content p-5">
                  <h4 className="fw-light" style={{ color: "#E78E7B" }}>
                    About Us
                  </h4>
                  ...
                  <div className="d-flex ticks">
                    <img
                      src={tick}
                      alt="Tick"
                      className="rounded-5 tick me-2"
                    />
              ...
              <div className="nmbs">
                <div
                  className="details text-white d-flex justify-content-center align-items-center mb-3 py-4 rounded-4 mx-5"
                  style={{ backgroundColor: "#411318" }}
                >
                  <div className="col-md-3 col-sm-6">
                    <div className="talents-found">
                      <h2>
                  ...
                  <div className="col-md-3 col-sm-6">
                    <div className="talents-found mx-4">
                      <h2>
                  ...
                  <div className="col-md-3 col-sm-6 no-longer">
                    <div className="talents-found mx-4">
                      <h2>
      ...
      <div className="container main-bg pt-5">
        <div className="row">
          ...
          <div className="col-md-6 mt-5 alignCenter">
            <h4 className="fw-bold">TRUE TALENTS</h4>
            <p>
              Our platform features a curated selection of professional
              <br className="break" />
              models, influencers, actors, athletes, & more, offering you{" "}
              <br className="break" />a seamless way to find & collaborate with
              the perfect.
            </p>
          </div>
          <div className="col-md-6 mt-5 chooseUs">
            <img src={whyChoose1} className="w-75" />
          </div>
          <div className="col-md-6 mt-5 chooseUs">
            <img src={whyChoose2} className="w-75" />
          </div>
          <div className="col-md-6 mt-5 chooseUs">
            <div>
              ...
              <div className="d-flex ticks my-2">
                <img src={tick} alt="Tick" className="rounded-5 tick me-2" />
      ...
      <div className="container position-relative" id="talents">
        ...
        >
          <div
            className="places-text mb-2 mb-md-0"
            style={{ marginTop: "60px" }}
            data-aos="zoom-out"
          >
            <h1 className="text-white fw-bold text-center">Meet Our Team</h1>
          ...
          <div className="row g-4 mt-3">
            <div className="d-flex justify-content-center align-items-center flex-nowrap team-container">
              {talents.map((talent, index) => (
                <div key={index} className="px-3 card-person me-2 rounded-4">
                  <div className="d-flex">
                    <div className="text-center">
                      <div
                        className="rounded-circle overflow-hidden mx-auto mb-2 meetOurTeam"
